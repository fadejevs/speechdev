...
import { Box, Typography, Button, IconButton, InputBase, Avatar, createTheme } from '@mui/material';
        ...
        >
          ...
          >
            ...
            <Box sx={{ display: 'flex', alignItems: 'center' }}>
              ...
              >
                <InputBase placeholder="Search here" sx={{ ml: 1 }} />
                <Typography sx={{ mx: 1, color: '#bdbdbd' }}>⌘ K</Typography>
              </Box>

              <IconButton sx={{ mr: 1 }}>🔔</IconButton>
